...
check_url="/uddiexplorer/SearchPublicRegistries.jsp?operator=http://127.0.0.1&rdoSearch=name&txtSearchname=sdf&txtSearchkey=&txtSearchfor=&selfor=Businesslocation&btnSubmit=Search"
